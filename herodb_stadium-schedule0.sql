...
CREATE TABLE `stadium-schedule` (
  ...
  PRIMARY KEY (`ss_num`),
  KEY `FK_stadium-timetable_TO_stadium-schedule_1` (`ss_st_id`),
  KEY `FK_reservation_TO_stadium-schedule_1` (`ss_rv_id`),
  CONSTRAINT `FK_reservation_TO_stadium-schedule_1` FOREIGN KEY (`ss_rv_id`) REFERENCES `reservation` (`rv_num`),
  CONSTRAINT `FK_stadium-timetable_TO_stadium-schedule_1` FOREIGN KEY (`ss_st_id`) REFERENCES `stadium-timetable` (`st_num`)
